...
func opsIsInvalid(err error) bool    { return err == ErrOpsInvalid }
func opsIsTransition(err error) bool { return err == ErrOpsTransition }
func opsIsPolicy(err error) bool     { return err == ErrOpsPolicy }
